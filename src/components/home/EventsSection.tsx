...
const EventsSection = () => {
  ...
  const eventSlides = [
    ...
    {
      id: "teachers-appreciation",
      title: "Teachers Appreciation Day",
      subtitle: "Celebrating the educators in our community",
      ...
      border: "#B5D4FF",
      textColor: "#0B3D91",
      icon: <Beer className="w-4 h-4 text-[#1D4ED8] mr-2" />,
    },
    {
      id: "first-responders-appreciation",
      title: "First Responders Appreciation Day",
      subtitle: "Honoring those who keep us safe",
      ...
      border: "#F7C7A3",
      textColor: "#8A3B12",
      icon: <Beer className="w-4 h-4 text-[#C05621] mr-2" />,
    },
    {
      id: "ladies-night",
      title: "Ladies Night",
      subtitle: "Gather your crew and celebrate",
